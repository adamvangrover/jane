# MEMORY: Longitudinal Context and ZPD Metrics

## Core Directive
This file tracks the evolving developmental metrics and verified decisions of the user. It is central to the adaptive capacity of the Jane system.
